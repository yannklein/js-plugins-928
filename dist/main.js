...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function disable(event) {
      ...
      event.currentTarget.disabled = true; // remove the class d-none form the reset button
...
_defineProperty(_default, "targets", ['reset', 'button']);
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      this.fetchOmdbAPI("star wars"); // search.addEventListener("click", searchMovies);
    }
  }, {
    key: "displayMovies",
    value: function displayMovies(movies) {
      ...
      movies.forEach(function (movie) {
        _this.resultsTarget.insertAdjacentHTML('beforeend', "<li class='list-inline-item'>\n        <img height=\"120\" src=\"".concat(movie.Poster, "\" alt=\"poster\" />\n        </li>"));
      });
    }
  }, {
    key: "fetchOmdbAPI",
    value: function fetchOmdbAPI(keyword) {
      var _this2 = this;
...
_defineProperty(_default, "targets", ['results', 'input']);
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    key: "connect",
    value: // static targets = [ 'test' ]
    function connect() {
      console.log('Hello from sortable_controller.js'); // console.log(this.testTarget)
